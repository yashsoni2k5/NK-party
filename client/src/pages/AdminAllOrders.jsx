...
import { FiShoppingCart, FiArrowLeft, FiMapPin, FiPackage, FiUser } from 'react-icons/fi';
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-[#E3BA63]/20 pb-6">
          <div className="space-y-1">
            ...
            <p className="text-gray-400 text-sm">
              Review placed orders, manage delivery addresses, and update fulfillment statuses.
            </p>
          </div>
        </div>
        ...
        {orders?.length === 0 ? (
          <div className="bg-[#011E15] border border-[#E3BA63]/30 p-12 rounded-3xl text-center shadow-xl">
            ...
            <p className="text-gray-400 text-sm">There are currently no customer orders placed on the platform.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {order.deliveryAddress ? (
                    <div className="bg-[#00271a] border border-[#E3BA63]/20 p-4 rounded-2xl space-y-2">
